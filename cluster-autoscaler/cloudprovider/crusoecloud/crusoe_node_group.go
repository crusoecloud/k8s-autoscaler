...
func (ng *crusoeNodeGroup) ForceDeleteNodes(nodes []*apiv1.Node) error {
	return cloudprovider.ErrNotImplemented
}
...
// TemplateNodeInfo returns a simulator framework NodeInfo structure of an empty
...
func (ng *crusoeNodeGroup) TemplateNodeInfo() (*framework.NodeInfo, error) {
